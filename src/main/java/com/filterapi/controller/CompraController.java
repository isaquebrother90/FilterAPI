...
public interface CompraController {
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(
                            responseCode = "200", description = "Compras encontradas",
                            content = @Content(
                                    mediaType = "application/json",
                                    schema = @Schema(implementation = Map.class),
                                    examples = @ExampleObject(value = "[{\"id\":1, \"produto\": \"Produto A\", \"valor\": 150.0}, {\"id\":2, \"produto\": \"Produto B\", \"valor\": 200.0}]"))
                    ),
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(
                            responseCode = "200", description = "Maior compra encontrada",
                            content = @Content(
                                    mediaType = "application/json",
                                    schema = @Schema(implementation = Map.class),
                                    examples = @ExampleObject(value = "{\"id\":1, \"produto\": \"Produto A\", \"valor\": 500.0}"))
                    ),
                    @ApiResponse(responseCode = "404", description = "Nenhuma compra encontrada para o ano fornecido"),
                    @ApiResponse(responseCode = "500", description = "Erro interno do servidor")
            }
    )
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(
                            responseCode = "200", description = "Clientes fiéis encontrados",
                            content = @Content(
                                    mediaType = "application/json",
                                    schema = @Schema(implementation = Map.class),
                                    examples = @ExampleObject(value = "[{\"id\":1, \"cliente\": \"Cliente A\", \"compras\": 10}, {\"id\":2, \"cliente\": \"Cliente B\", \"compras\": 8}]"))
                    ),
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(
                            responseCode = "200", description = "Recomendação de vinho encontrada",
                            content = @Content(
                                    mediaType = "application/json",
    ...
    String getRecomendacao(
            @Parameter(description = "CPF do cliente para obter a recomendação") @PathVariable String cpf
    );
}